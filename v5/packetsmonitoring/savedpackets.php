<?php
    ...
    $query = ('SELECT * FROM paquets WHERE username = ?');
    ...
    <nav>
       ...
       <main>
            ...
            <div class = "content-box">
                ...
                <div>
                    <p>
                        <a href="suivi.php" role="button" class="btn btn-primary " style="background-color: #8167a9; border-color: #8167a9; ">New capture</a>
