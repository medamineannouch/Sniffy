<?php
    ...
    for($i=0;$i<count($_SESSION['$CSVRAW'])/9;$i++){
        ...
        $request->execute(array($_SESSION['$CSVRAW'][$i*9],$_SESSION['$CSVRAW'][$i*9+1],$_SESSION['$CSVRAW'][$i*9+2],$_SESSION['$CSVRAW'][$i*9+3],$_SESSION['$CSVRAW'][$i*9+4],$_SESSION['$CSVRAW'][$i*9+5],$_SESSION['$CSVRAW'][$i*9+6],$_SESSION['$CSVRAW'][$i*9+7],$_SESSION['$CSVRAW'][$i*9+8],$_SESSION['$CSVRAW'][$i*9+9]));
    }
